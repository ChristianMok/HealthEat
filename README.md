...
### TASK 3: MEAL PLANNING (Select the recipes)
#### Routine and simple task.
...
### TASK 5: CREATE SHOPPING LIST (Recipe → Buy food)
#### Routine and simple task.
...
### TASK 6: RECIPE RECOMMENDATION (Buy food → Recipe)
#### Routine and simple task.
